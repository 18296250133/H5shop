<template>
  <div>
     <tabcontainer id="tabber">
       ...
       <tabitem path="/shopcart" activecolor="pink">
       ...
       <tabitem path="/profile" activecolor="pink">
...
export default {
     components:{
          tabcontainer:()=>import ('../../common/tabbar/tabcontainer'),
          tabitem:()=>import('../../common/tabbar/tabitem')
     }
}
</script>
